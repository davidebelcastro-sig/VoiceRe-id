...
def new_training(path_label):
    ...
    zip_file_path = "./modelli/modello_combinato.zip"
    ...
    if os.path.exists(extracted_folder+"modello_combinato.pkl"):
        pass
    else:
    ...
    with open(extracted_folder+"modello_combinato.pkl", 'rb') as file:
