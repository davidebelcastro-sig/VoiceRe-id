...
csv_file_test_path = "./file_csv/features_test.csv"
...
def process_audio_files(data_dir):
        ...
        with open(csv_file_test_path, mode='w', newline='') as file:
        ...
        for i in range(1,61):
            ...
            for file in os.listdir(path):
                if file.endswith('.wav'):
                    ...
                    with open(csv_file_test_path, mode='a', newline='') as file:
                        writer = csv.writer(file)
                        writer.writerow(row)
...
if __name__ == "__main__":
    data_directory = "./data/test_data"  # Sostituisci con il percorso reale
    process_audio_files(data_directory)
