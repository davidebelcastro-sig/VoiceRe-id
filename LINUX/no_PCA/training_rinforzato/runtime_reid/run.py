...
btn2 = customtkinter.CTkButton(master = root, text = "Runtime re-id", height=40, corner_radius=8, fg_color="transparent", 
                hover_color="white", border_color="#93f233", text_color="#93f233", border_width=2, command=runtime_reid)
