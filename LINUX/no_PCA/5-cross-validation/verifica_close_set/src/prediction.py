...
if __name__ == '__main__':
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_combinato.pkl", "./csv/accessi_combined.csv")
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_0.pkl", "./csv/accessi_0.csv")
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_1.pkl", "./csv/accessi_1.csv")
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_2.pkl", "./csv/accessi_2.csv")
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_3.pkl", "./csv/accessi_3.csv")
    pred("./csv/features_train.csv", "./csv/features_test.csv", "./modelli/modello_4.pkl", "./csv/accessi_4.csv")